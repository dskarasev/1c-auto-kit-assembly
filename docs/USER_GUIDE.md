...
- Может быть: 00:00, 06:00, 12:00, 18:00, 21:00 и т.д.
...
- По умолчанию: дата анализа минус 1 день
- Должна быть РАНЬШЕ даты анализа

#### Время комплектации
- На какой момент проводить документы
- По умолчанию: время анализа минус 2 часа
- Обычно устанавливается рано утром (03:00-06:00)
...
### Способ 1: Прямое редактирование в таблице
...
### Способ 2: Использование кнопки настройки

1. **Выделите строку** с нужным набором
2. **Нажмите "Настроить выбранный набор..."**
...
4. Для 10 новых:
   ...
   - Или используйте кнопку "Настроить"
